    ...
    receiptAmount: {
      ...
      validate: {
        ...
        validator: function validateAmount(amount, cb) {
          ...
          try {console.log('user in vali: ', this.user)
          ...
          } catch (err) {console.log('try err: ', err)  // either this.receiptAsset/this.user is undefined or this.reciptAddress is not in user's asssetAccounts
