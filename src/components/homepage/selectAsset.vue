<template>
  <div id="asset-select" class="header__table-cell header__cta-form">
    <div class="cta-form">
      <div class="cta-form__assets-selection">
        ...
        <form class="input-fields" @submit.prevent="proceed">
          <div class="select-component custom-form-group">
            ...
            <vue-select :options="assets" :on-change="val => setSelect('deposit', 'depositAsset', val)" input-id="deposit" label="name">
          ...
          <div class="select-component custom-form-group">
            ...
            <vue-select :options="assets" :on-change="val => setSelect('receipt', 'receiptAsset', val)" input-id="receipt" label="name">
              <template slot="option" slot-scope="option">
                <img :src="`${global.apiRootUrl}/${option.imagePath}`" style="height:2rem; margin-right: .3rem; margin-bottom: 0; line-height: 1"> {{ option.name }}
              </template>
            </vue-select>
          ...
          <div class="textbox-component">
            ...
            <input id="amount" v-model="amount" type="number" placeholder="0" step="0.0000001">
          </div>
        ...
        <label :disabled="!isValidated" for="submitbutton" tabindex="0" class="convert btn-custom-astronaut-blue">
          Convert
        </label>
      </div>
    </div>
